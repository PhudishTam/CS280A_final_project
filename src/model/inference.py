    ...
    with torch.no_grad():
        for batch in validation_dataloader:
            ...
            with torch.no_grad():
                ...
                negative_captions = ["Remove grayscale from the image" for i in range(positive_text_hidden_state.shape[0])]
            ...
            z_x = model.sample(vae, gray_images, num_steps, device, positive_text_embedding, negative_text_embedding, guidance_scale=1.6, color_scale=0.8)
            ...
            torchvision.utils.save_image(decoded_samples, "decoded_samples.png")
